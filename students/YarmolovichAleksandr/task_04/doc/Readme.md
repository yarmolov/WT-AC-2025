...
1. Список альбомов с состоянием loading или пустым списком.
...
2. Детальная страница альбома.

- Детальная страница
![Детали страницы](img/Details.png)

3. Форма добавления/редактирования.
...
4. Уведомление об успешной операции.

- Уведомление об успешной операции

![Редактирование](img/Notification.png)

5. DevTools → Network с примерами CRUD-запросов.
